...
namespace WebUntisNet.Rpc
{
    public interface IRpcClient
    {
        ...
        /// <param name="sessionId">The session id returned by <see cref="AuthenticateAsync"/>.</param>
        /// <returns>The rpc response.</returns>
        Task<HolidaysResponse> GetHolidaysAsync(HolidaysRequest request, string sessionId);
        ...
        /// <param name="sessionId">The session id returned by <see cref="AuthenticateAsync"/>.</param>
        /// <returns>The rpc response.</returns>
        Task<TimetableResponse> GetTimetableAsync(SimpleTimetableRequest request, string sessionId);
        ...
        /// <param name="sessionId">The session id returned by <see cref="AuthenticateAsync"/>.</param>
        /// <returns>The rpc response.</returns>
        Task<LatestImportTimeResponse> GetLatestImportTimeAsync(LatestImportTimeRequest request, string sessionId);
        ...
        /// <param name="sessionId">The session id returned by <see cref="AuthenticateAsync"/>.</param>
        /// <returns>The rpc response.</returns>
        Task<PersonIdResponse> GetPersonIdAsync(PersonIdRequest request, string sessionId);
        ...
        /// <param name="sessionId">The session id returned by <see cref="AuthenticateAsync"/>.</param>
        /// <returns>The rpc response.</returns>
        Task<SubstitutionsResponse> GetSubstitutionsAsync(SubstitutionsRequest request, string sessionId);
        ...
        /// <param name="sessionId">The session id returned by <see cref="AuthenticateAsync"/>.</param>
        /// <returns>The rpc response.</returns>
        Task<ClassregEventsResponse> GetClassregEventsAsync(ClassregEventsRequest request, string sessionId);
        ...
        /// <param name="sessionId">The session id returned by <see cref="AuthenticateAsync"/>.</param>
        /// <returns>The rpc response.</returns>
        Task<ExamsResponse> GetExamsAsync(ExamsRequest request, string sessionId);
        ...
        /// <param name="sessionId">The session id returned by <see cref="AuthenticateAsync"/>.</param>
        /// <returns>The rpc response.</returns>
        Task<ExamTypesResponse> GetExamTypesAsync(ExamTypesRequest request, string sessionId);
    }
