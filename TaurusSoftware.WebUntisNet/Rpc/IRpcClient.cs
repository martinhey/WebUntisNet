...
namespace TaurusSoftware.WebUntisNet.Rpc
{
    public interface IRpcClient
    {
        ...
        /// <param name="token">The cancellation token.</param>
        /// <returns>The rpc response.</returns>
        Task<CurrentSchoolYearResponse> GetCurrentSchoolYearAsync(CurrentSchoolYearRequest request, string sessionId, CancellationToken token = default(CancellationToken));
